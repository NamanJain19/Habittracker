      ...
      <main className="pt-24 pb-16 px-6 lg:px-8">
        <div className="max-w-[100rem] mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            >
              <h1 className="font-heading text-5xl lg:text-6xl font-bold">
                <span className="text-light-foreground">Wellness</span>{' '}
            ...
            <Dialog open={isDialogOpen} onOpenChange={(open) => {
              ...
              <DialogContent className="bg-dark-background border-white/10 max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <Label htmlFor="moodRating" className="font-paragraph text-light-foreground">
                  ...
                  <div>
                    <Label htmlFor="stressLevel" className="font-paragraph text-light-foreground">
                  ...
                  <div>
                    <Label htmlFor="energyLevel" className="font-paragraph text-light-foreground">
                  ...
                  <div>
                    <Label htmlFor="journalEntry" className="font-paragraph text-light-foreground">Journal Entry</Label>
                    <Textarea
                      id="journalEntry"
                      value={formData.journalEntry}
                      onChange={(e) => setFormData({ ...formData, journalEntry: e.target.value })}
                      placeholder="How are you feeling today?"
                      className="bg-white/5 border-white/10 text-light-foreground font-paragraph min-h-[100px]"
                    />
                  </div>
                  <div>
                    <Label htmlFor="checkinDateTime" className="font-paragraph text-light-foreground">Date & Time</Label>
                    <Input
                      id="checkinDateTime"
                      type="datetime-local"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="font-paragraph text-sm text-light-foreground/60 mb-2">Avg Mood</div>
            ...
            <motion.div
              ...
              className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6"
            >
              <div className="font-paragraph text-sm text-light-foreground/60 mb-2">Avg Stress</div>
            ...
            <motion.div
              ...
              className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6"
            >
              <div className="font-paragraph text-sm text-light-foreground/60 mb-2">Avg Energy</div>
          ...
          <div className="min-h-[400px]">
            {isLoading ? null : checkins.length > 0 ? (
                    ...
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        {checkin.journalEntry && (
                          <p className="font-paragraph text-sm text-light-foreground/80 mb-3">
                            {checkin.journalEntry}
                          </p>
                        )}
              ...
              >
                <Heart className="w-16 h-16 text-light-foreground/30 mx-auto mb-4" />
