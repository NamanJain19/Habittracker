    ...
    theme: {
        extend: {
            fontSize: {
                ...
                '2xl': ['1.5rem', { lineHeight: '1.2', letterSpacing: '0.04em', fontWeight: '600' }],
                '3xl': ['1.875rem', { lineHeight: '1.15', letterSpacing: '0.03em', fontWeight: '600' }],
                '4xl': ['2.25rem', { lineHeight: '1.1', letterSpacing: '0.02em', fontWeight: '700' }],
                '5xl': ['3rem', { lineHeight: '1.05', letterSpacing: '0.01em', fontWeight: '700' }],
                '6xl': ['3.75rem', { lineHeight: '1', letterSpacing: '0', fontWeight: '800' }],
